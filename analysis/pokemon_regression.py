...
def pokemon_regression_analysis(set_name, set_data, z_set_data, modified_data_tag=''):
    # ----------------------------------------------------------------------------------
    ...
    if modified_data_tag == '(trimmed Height(m) & Weight(kg))' \
            or modified_data_tag == '(trimmed Height(m) and Weight(kg))':
        print(loaddata.trim_data_h_w)
    if modified_data_tag == '(trimmed Height(m))':
        print(loaddata.trim_data_h)
    if modified_data_tag == '(trimmed Weight(kg))':
        print(loaddata.trim_data_w)
    ...
    plt.title(f"Figure {curr_fig}: {set_name} Stat Point Data")
    plt.show()
    # ----------------------------------------------------------------------------------
    ...
    plt.title(f"Figure {curr_fig}: {set_name} Stat Point Data (standardized)")
    plt.show()
    print(f'{separator + separator}\n')
    # ----------------------------------------------------------------------------------
    ...
    plt.title(f"Figure {curr_fig}: {set_name} Height(m) and Weight(kg)")
    plt.show()
    print(f'{separator + separator}\n')
    # ----------------------------------------------------------------------------------
    ...
    plt.title(f"Figure {curr_fig}: {set_name} Height(m) and Weight(kg) (standardized)")
    plt.show()
    print(f'{separator + separator}\n')
    # ----------------------------------------------------------------------------------
